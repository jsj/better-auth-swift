...
public enum BetterAuthError: LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        ...
        case .randomBytesUnavailable:
            return "Secure random bytes are unavailable."
...
public enum AuthErrorCode: String, Codable, Sendable, Equatable {
    ...
    public var description: String {
        switch self {
        case .sessionExpired: "The session expired."
        case .sessionNotFound: "Session not found."
        case .refreshTokenExpired: "The refresh token expired."
        ...
        case .otpExpired: "The OTP expired."
        case .invalidOTP: "Invalid OTP code."
        case .verificationExpired: "The verification expired."
        ...
        case .mfaChallengeExpired: "The MFA challenge expired."
        ...
        case .rateLimited, .tooManyRequests: "Too many requests. Try again later."
