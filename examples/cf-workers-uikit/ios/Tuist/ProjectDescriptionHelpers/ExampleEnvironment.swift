...
public enum ExampleEnvironmentDefaults {
    ...
    private static let defaults: [String: String] = ["TUIST_API_BASE_URL": "http://127.0.0.1:8787",
    ...
    public static let environmentArguments = Arguments
        .arguments(environmentVariables: ["API_BASE_URL": EnvironmentVariable.environmentVariable(value: apiBaseURL,
                                                                                                  isEnabled: true)])
}
