...
let project = Project(name: "BetterAuthUIKitExample",
                      options: .options(defaultKnownRegions: ["en"],
                                        developmentRegion: "en"),
                      packages: [.package(path: "../../..")],
                      settings: .settings(base: ["SWIFT_VERSION": "6.0"]),
                      targets: [.target(name: "BetterAuthUIKitExample",
                                        destinations: .iOS,
                                        product: .app,
                                        bundleId: "sh.jsj.better-auth-swift-uikit-example.apple",
                                        deploymentTargets: .iOS("17.0"),
                                        infoPlist: .extendingDefault(with: ["CFBundleDisplayName": "BetterAuthUIKitExample",
                                        ...
                                        dependencies: [.package(product: "BetterAuth"),
                                                       .package(product: "BetterAuthMagicLink")],
                                        settings: .settings(base: targetBaseSettings),
                                        additionalFiles: ["App/Sources/Auth/Views/**"]),
                                .target(name: "BetterAuthUIKitExampleTests",
                                        destinations: .iOS,
                                        product: .unitTests,
                                        ...
                                        infoPlist: .default,
                                        sources: ["App/Tests/**"],
                                        dependencies: [.target(name: "BetterAuthUIKitExample"),
